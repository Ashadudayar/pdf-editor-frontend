    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Repair PDF</h1>
        ...
        {!result ? (
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              >
                ...
                <p className="text-lg font-semibold text-gray-700 mb-2">
                  {file ? file.name : 'Upload PDF to Repair'}
                </p>
                <p className="text-sm text-gray-500">Corrupted or damaged PDFs</p>
              </label>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">PDF Repaired!</h3>
            ...
            {result.pages_recovered && (
              <p className="text-sm text-gray-500 mb-4">Pages recovered: {result.pages_recovered}</p>
            )}
