...
import { Presentation, Upload, Download, Loader2, CheckCircle, AlertCircle } from 'lucide-react';
...
export default function PowerPointToPDFTool() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/powerpoint-to-pdf/`, {
        method: 'POST',
        body: formData,
      });
      ...
      setError('Failed to convert PowerPoint');
    } finally {
      setProcessing(false);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">PowerPoint to PDF</h1>
          <p className="text-gray-600">Convert .pptx presentations to PDF</p>
        </div>
        ...
        {!result ? (
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              >
                ...
                <p className="text-lg font-semibold text-gray-700 mb-2">
                  {file ? file.name : 'Upload PowerPoint'}
                </p>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Your presentation has been converted</p>
