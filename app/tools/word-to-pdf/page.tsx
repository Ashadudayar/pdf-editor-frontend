    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">WORD to PDF</h1>
          <p className="text-gray-600">Convert .docx documents to PDF</p>
        </div>
        ...
        {!result ? (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Your document has been converted successfully</p>
            ...
            {result.pdf_size_mb && (
              <p className="text-sm text-gray-500 mb-4">Size: {result.pdf_size_mb} MB</p>
            )}
