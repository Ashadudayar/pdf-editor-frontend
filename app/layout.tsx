...
export const metadata: Metadata = {
  ...
  description: "Free online PDF tools to edit, convert, merge, split, compress, and secure your PDFs. 28+ professional PDF tools. No signup required.",
  keywords: ["PDF editor", "PDF converter", "merge PDF", "split PDF", "compress PDF", "free PDF tools"],
};
